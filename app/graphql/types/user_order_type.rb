...
module Types
  class UserOrderType < Types::BaseEnum
    ...
    value "ADMINS_LAST", description: "Sort users with admins pushed to the bottom, followed by name Z-A"
    value "ADMINS_RECENT", description: "Sort users with admins pushed to the top, followed by recent"
    value "ADMINS_OLDEST", description: "Sort users with admins pushed to the bottom, followed by `OLDEST`"
