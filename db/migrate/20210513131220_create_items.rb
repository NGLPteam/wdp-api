...
class CreateItems < ActiveRecord::Migration[6.1]
  def change
    create_table :items, id: :uuid do |t|
      t.references :collection, null: false, foreign_key: { on_delete: :restrict }, type: :uuid
      t.references :schema_definition, null: false, foreign_key: { on_delete: :restrict }, type: :uuid
      t.references :parent, null: true, foreign_key: { to_table: :items, on_delete: :restrict }, type: :uuid
